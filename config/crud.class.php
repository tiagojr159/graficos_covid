...
class crud {
 ...
 public function inserir_registro($registro) { // funçao de inserçao, campos e seus respectivos valores como parametros
	
		if (!$this->ins = mysqli_query($this->con, $registro)) {
           echo "<br><br><font color='red'> erro ao inserir registro.<BR>$registro</font>";
        } else {
        //    $pieces = explode("_", $this->tabela);
		//print "<script>location='index.php?tela=" . $pieces[1] . "';</script>";
        }
